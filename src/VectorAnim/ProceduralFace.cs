...
public struct ProceduralFace : IFlatbufferObject
{
  ...
  public float ScanlineOpacity { get { int o = __p.__offset(20); return o != 0 ? __p.bb.GetFloat(o + __p.bb_pos) : (float)1.0f; } }
  ...
  public static Offset<ProceduralFace> CreateProceduralFace(FlatBufferBuilder builder,
    ...
    ProceduralFace.AddScanlineOpacity(builder, scanlineOpacity);
  ...
  public static void StartProceduralFace(FlatBufferBuilder builder) { builder.StartObject(9); }
  ...
  public static void AddScanlineOpacity(FlatBufferBuilder builder, float scanlineOpacity) { builder.AddFloat(8, scanlineOpacity, 1.0f); }
